...
<div class="col-md-12">
    <div class="card">
        ...
        <h5>Update Kendaraan</h5>
            <span>Pastikan <code>Data Kendaraan</code> telah <code>sesuai</code></span>
        </div>
        <div class="card-block">
            <form action="{{ url('admin_mobil_update/'.$mobil->id_mobil) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nopol" class="form-control" value="{{$mobil->nopol}}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Tarif sewa/hari</label>
                    <div class="col-sm-10">
                        <input type="number" name="tarif" class="form-control" value="{{$mobil->tarif}}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Foto</label>
                    <div class="col-sm-10">
                        <img src="{{ url('uploads') }}/{{ $mobil->foto }}" alt="..." class="img-thumbnail" style="width: 240px;">
